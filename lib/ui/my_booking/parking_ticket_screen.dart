...
import 'package:mekinaparking/constant/send_notification.dart';
import 'package:mekinaparking/constant/show_toast_dialog.dart';
import 'package:mekinaparking/controller/dashboard_controller.dart';
import 'package:mekinaparking/controller/parking_ticket_controller.dart';
...
import 'package:mekinaparking/ui/live_tracking_screen/live_tracking_screen.dart';
...
import 'package:mekinaparking/utils/utils.dart';
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        "${controller.orderModel.value.userVehicle!.vehicleBrand!.name.toString()} ${controller.orderModel.value.userVehicle!.vehicleModel!.name.toString()} (${controller.orderModel.value.userVehicle!.vehicleNumber})",
                                        style: TextStyle(
                                          color: themeChange.getThem()
                                              ? AppThemData.grey06
                                              : AppThemData.grey09,
