...
import 'package:mekinaparking/controller/referral_controller.dart';
...
class ReferAndEarnScreen extends StatelessWidget {
  ...
  Future<void> share(ReferralController controller) async {
    ...
    await Share.share(
      "Hey there, thanks for choosing MekinaParking. Hope you love our product. If you do, share it with your friends using code ${controller.referralModel.value.referralCode.toString()} and get ${Constant.amountShow(amount: Constant.referralAmount)}.",
    );
  }
}
