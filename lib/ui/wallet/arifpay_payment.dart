...
class _ArifPayPaymentScreenState extends State<ArifpayPaymentScreen> {
  ...
  void initState() {
    initController();
    log("notifyUrl :: ${widget.initialURl}");
    super.initState();
  }
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onNavigationRequest: (NavigationRequest navigation) async {
            print("navigationurll ${navigation.url}");

            // if (navigation.url.contains("/success") || navigation.url.contains("/?transactionNo=")) {
            ...
            // if (navigation.url.contains("/?transactionNo=")) {
