...
import 'package:mekinaparking/ui/add_select_vehicle/add_new_vehical_screen.dart';
                              ...
                              child: ListView.separated(
                                ...
                                itemBuilder: (context, int index) {
                                  ...
                                  Map<String, String> qrDataMap = {
                                    "vehicleNumber": userVehicleModel
                                        .vehicleNumber
                                        .toString(),
                                    "userId":
                                        userVehicleModel.userId.toString(),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: RoundedButtonFill(
                        ...
                        fontSizes: 16,
                        onPress: () {
                          BookingParkingDetailsController
                              bookingParkingDetailsController =
                              Get.put(BookingParkingDetailsController());
                          bookingParkingDetailsController.selectedVehicle
