...
import 'package:mekinaparking/controller/home_controller.dart';
...
import 'package:mekinaparking/ui/booking_process/booking_parking_details_screen.dart';
...
import 'package:mekinaparking/ui/search/search_screen.dart';
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: GetX<HomeController>(
            init: HomeController(),
            builder: (controller) {
              print("controller.parkingList ${controller.parkingList}");
