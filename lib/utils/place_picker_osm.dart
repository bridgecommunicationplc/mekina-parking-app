...
import 'package:mekinaparking/utils/osm_map_search_place.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Colors.blue,
        child: Icon(Icons.my_location, color: themeChange.getThem() ? AppThemData.primary01 : AppThemData.primary03),
      ),
    );
  }
