...
import 'package:mekinaparking/payment/RazorPayFailedModel.dart';
...
class PaymentSelectController extends GetxController {
  ...
  completeCashOrder() async {
    ...
    await SendNotification.sendOneNotification(
        token: receiverUserModel != null
            ? receiverUserModel.fcmToken.toString()
            : "",
